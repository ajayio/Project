...
<html>
    ...
    <script>
        ...
        function doGetServlet(){            
            ...
            var target = document.getElementById("viewListInput").value;
            var submit = document.getElementById("submit").value;
            alert("Target : "+target+" "+"Option :"+option);
            if(option !== null){
                switch(option){
                    case "circularId" :
                    ...
                    case "marked" :
                        ...
                        url = "../ViewedListServlet?option="+option+"&target="+target+"&submit="+submit+"&markedOption="+markedOption;
                        var request = new XMLHttpRequest();
                        request.onreadystatechange = function () {
                        if((request.readyState === 4)&&(request.status === 200)){                           
                            responseText = request.responseText;
